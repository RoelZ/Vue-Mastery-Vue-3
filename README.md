...
![Lifecycle hooks](https://firebasestorage.googleapis.com/v0/b/vue-mastery.appspot.com/o/flamelink%2Fmedia%2F2.opt.1605053999988.jpg?alt=media&token=2740b38d-e8f7-49df-9052-eee6c045d156)
...
![Problem with current code](https://firebasestorage.googleapis.com/v0/b/vue-mastery.appspot.com/o/flamelink%2Fmedia%2F3.opt.1605054009862.jpg?alt=media&token=d1a74c9d-682c-4978-bf77-a1d767fe9f1e)
...
![Modularizing using a Service](https://firebasestorage.googleapis.com/v0/b/vue-mastery.appspot.com/o/flamelink%2Fmedia%2F4.opt.1605054014815.jpg?alt=media&token=f1f583d2-d971-4c1c-b272-9a0878142539)
...
```
As you can see, we still have access to the Axios `get` method, and we’re passing in '`/events`' as the argument when making this call. This string will be added to our `baseURL`, so the request will be made to: '`https://us-central1-gotvotes-71a47.cloudfunctions.net/getEvents/`'
...
[<< Previous lesson](https://github.com/RoelZ/Vue-Mastery-Vue-3/tree/L4-start)
 | 
 [Next lesson >>](https://github.com/RoelZ/Vue-Mastery-Vue-3/tree/L6-start)
